...
* **easeout**
    ...
    * Not played unless it's at the end of an episode run
* **tbc**
    * Marks the "To Be Continued" scene
...
* **signoff**
    ...
    * Optionally played at the end of an episode run
* **filler**
    * Used to mark segments that should never included in the render under any circumstances
    ...
    * **IMPORTANT** - `filler` tags can be placed within larger `segment` tags, but they must be entirely contained within one tag without extending beyond either border. Placing a `filler` tag within any other tag will have no effect
